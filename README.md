...
| 4 | Определение перспективного тарифа для телеком-компании | На небольшой выборке из 500 пользователей компании «Мегалайна» проанализировать поведение клиентов и выбрать оптимальный тариф | `Python` `Pandas` `Matplotlib` `NumPySciPy` `Описательная статистика` `Проверка статистических гипотез` |
